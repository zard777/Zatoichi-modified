...
local function init()
    ...
    inst.components.explosive.explosivedamage = TUNING.QUCKIE_DAMAGE -- default 61
	...
	inst:DoTaskInTime(0, function() 
		...
		if inst.components.homeseeker and inst.quickiemeter == nil then
			...
			--meter.Transform:SetScale(1.4, 1.4, 1.4)	
		end
	end)
...
return Prefab("common/inventory/quickiebomb", init, assets, prefabs)